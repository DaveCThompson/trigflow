...
export const CanvasHeader: React.FC<CanvasHeaderProps> = ({
    ...
    return (
        <div
            className="glass-header absolute top-4 left-1/2 -translate-x-1/2 z-20 flex items-center gap-4 px-6 py-3 bg-ui-bg-panel/60 backdrop-blur-md rounded-full border border-white/20 shadow-lg transition-colors duration-300"
            style={{
